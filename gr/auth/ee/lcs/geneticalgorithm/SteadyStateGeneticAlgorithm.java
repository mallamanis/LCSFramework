...
/** 
 *  A steady-stage GA that selects two individuals
 *  from a set (with probability proportional to their 
 *  total fitness) and performs a crossover and mutation
...
public class SteadyStateGeneticAlgorithm implements IGeneticAlgorithmStrategy {
  ...
  /**
   * The GA activation age. The population must have an average age, 
   * greater that this in order for the GA to run.
   */
