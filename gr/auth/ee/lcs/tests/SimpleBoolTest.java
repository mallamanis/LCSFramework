...
public class SimpleBoolTest {
	...
	public static void main(String[] args) {
		...
		ClassifierSet rulePopulation=new ClassifierSet(new FixedSizeSetWorstFitnessDeletion(300,
				new TournamentSelector(50,false,UpdateAlgorithmFactoryAndStrategy.COMPARISON_MODE_DELETION)));
			...
			for (int a=0;a<2;a++)
				for (int b=0;b<2;b++)
					for (int c=0;c<2;c++){
						...
						myExample.trainWithInstance(rulePopulation, 4*a+2*b+c, trainSet[a][b][c]);
