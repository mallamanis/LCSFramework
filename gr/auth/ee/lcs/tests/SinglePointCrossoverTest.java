...
public class SinglePointCrossoverTest extends SinglePointCrossover {
	...
	public void testOperateCrossover() {
		...
		for (int i = 0; i < 500; i++) {
			...
			if (result.equals("0000000")) atLeastOnce[0] = true;
			if (result.equals("1000000")) atLeastOnce[1] = true;
			if (result.equals("1100000")) atLeastOnce[2] = true;
			if (result.equals("1110000")) atLeastOnce[3] = true;
			if (result.equals("1111000")) atLeastOnce[4] = true;
			if (result.equals("1111100")) atLeastOnce[5] = true;
			if (result.equals("1111110")) atLeastOnce[6] = true;
			if (result.equals("1111111")) atLeastOnce[7] = true;
		}
