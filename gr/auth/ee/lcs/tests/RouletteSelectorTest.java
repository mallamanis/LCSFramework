...
public class RouletteSelectorTest {
	...
	/**
	 * Test method for {@link gr.auth.ee.lcs.geneticalgorithm.selectors.RouletteWheelSelector#select(int, gr.auth.ee.lcs.classifiers.ClassifierSet, gr.auth.ee.lcs.classifiers.ClassifierSet)}.
	 */
	@Test
	public void testSelect() {
		RouletteWheelSelector selector = new RouletteWheelSelector(AbstractUpdateStrategy.COMPARISON_MODE_EXPLORATION, true);
		...
		for (int i = 0; i < atLeastOnce.length; i++) {
			assertTrue("Might fail with probability 1 -(13/14)^500",atLeastOnce[i]);
		}
	...
	public void testSelectMin() {
		RouletteWheelSelector selector = new RouletteWheelSelector(AbstractUpdateStrategy.COMPARISON_MODE_EXPLORATION, false);
	...
	public void testZeroSelectionMin() {
		...
		for (int i = 0; i < atLeastOnce.length; i++) {
			assertTrue("Might fail with probability 1 -(9/14)^500",atLeastOnce[i]);
		}
