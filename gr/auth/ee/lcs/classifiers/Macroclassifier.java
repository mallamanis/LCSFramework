...
/** 
 *  Represents a macroclassifier. 
 *  A macroclassifier is a classifier with a numerosity.
 */
public class Macroclassifier implements Serializable {
   ...
   * @param macroClassifier the macroclassifier to be tested 
   * 	for equality to this macroclassifier
   * @return true if the classifier and 
   * 	the macro-classifier represent the same rule
   */
