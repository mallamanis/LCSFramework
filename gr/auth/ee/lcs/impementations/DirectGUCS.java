...
public class DirectGUCS {
	 ...
	 */
	private final int THETA_GA = (int) SettingsLoader.getNumericSetting("thetaGA", 500);
	...
	public void run() throws IOException {
		...
		GenericMultiLabelRepresentation rep = new GenericMultiLabelRepresentation(
				...
				StrictMultiLabelRepresentation.EXACT_MATCH, LABEL_GENERALIZATION_RATE, ATTRIBUTE_GENERALIZATION_RATE);
