...
public class SequentialMlUpdateAlgorithmTest {
	...
	public void setUp() throws Exception {
		...
		update = new SequentialMlUpdateAlgorithm(mockStrategy,mockGa, NUM_OF_LABELS);
	}
	...
	/**
	 * Test method for {@link gr.auth.ee.lcs.data.updateAlgorithms.SequentialMlUpdateAlgorithm#cover(gr.auth.ee.lcs.classifiers.ClassifierSet, int)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link gr.auth.ee.lcs.data.updateAlgorithms.SequentialMlUpdateAlgorithm#createStateClassifierObject()}.
	 */
	@Test
	public void testCreateStateClassifierObject() {
		...
		expect(mockStrategy.createStateClassifierObject()).andReturn(obj).times(10);
		replay(mockStrategy);
		for (int i = 0; i < 10; i++)
	...
	/**
	 * Test method for {@link gr.auth.ee.lcs.data.updateAlgorithms.SequentialMlUpdateAlgorithm#getComparisonValue(gr.auth.ee.lcs.classifiers.Classifier, int)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link gr.auth.ee.lcs.data.updateAlgorithms.SequentialMlUpdateAlgorithm#getData(gr.auth.ee.lcs.classifiers.Classifier)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link gr.auth.ee.lcs.data.updateAlgorithms.SequentialMlUpdateAlgorithm#performUpdate(gr.auth.ee.lcs.classifiers.ClassifierSet, gr.auth.ee.lcs.classifiers.ClassifierSet)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link gr.auth.ee.lcs.data.updateAlgorithms.SequentialMlUpdateAlgorithm#updateSet(gr.auth.ee.lcs.classifiers.ClassifierSet, gr.auth.ee.lcs.classifiers.ClassifierSet, int, boolean)}.
	 */
	@Test
