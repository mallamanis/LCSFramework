...
public class AbstractLearningClassifierSystemTest {
	...
	public void setUp() throws Exception {
		lcs = createMockBuilder(AbstractLearningClassifierSystem.class)
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#getClassifierTransformBridge()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#getNewClassifier()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#getNewClassifier(gr.auth.ee.lcs.utilities.ExtendedBitSet)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#getRulePopulation()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#getUpdateStrategy()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#setElements(gr.auth.ee.lcs.data.ClassifierTransformBridge, gr.auth.ee.lcs.data.AbstractUpdateStrategy)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#setRulePopulation(gr.auth.ee.lcs.classifiers.ClassifierSet)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#trainSet(int, gr.auth.ee.lcs.classifiers.ClassifierSet)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#trainSet(int, gr.auth.ee.lcs.classifiers.ClassifierSet, boolean)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#trainWithInstance(gr.auth.ee.lcs.classifiers.ClassifierSet, int)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link gr.auth.ee.lcs.AbstractLearningClassifierSystem#updatePopulation(int, gr.auth.ee.lcs.classifiers.ClassifierSet)}
	 * .
	 */
	@Test
