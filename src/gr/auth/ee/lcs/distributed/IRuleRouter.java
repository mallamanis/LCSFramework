...
/**
 * A rule router interface. Receives rules from the LCS and sends them accordingly.
...
public interface IRuleRouter {
	 ...
	 * @param sendRules the rules to send
	 */
	 ...
	 * @param rules the rules just received
	 * @param metadata any meta-data
	 */
